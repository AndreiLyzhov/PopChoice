...
Sha1.prototype.update = function(message) {
  ...
  var code, index2 = 0, i, length = message.length || 0, blocks3 = this.blocks;
  while (index2 < length) {
    if (this.hashed) {
      this.hashed = false;
    ...
    if (notString) {
      for (i = this.start; index2 < length && i < 64; ++index2) {
        blocks3[i >> 2] |= message[index2] << SHIFT[i++ & 3];
      }
    } else {
      for (i = this.start; index2 < length && i < 64; ++index2) {
...
Sha256.prototype.update = function(message) {
  ...
  var code, index2 = 0, i, length = message.length, blocks3 = this.blocks;
  while (index2 < length) {
    if (this.hashed) {
      this.hashed = false;
      blocks3[0] = this.block;
...
async function index(args) {
  ...
  for (const batch of batches) {
    ...
    if (cleanup === "incremental") {
      hashedDocs.forEach((_hashedDoc, index2) => {
        const source = sourceIds[index2];
        if (source === null) {
...
@langchain/core/dist/utils/js-sha256/hash.js:
   ...
   *)
*/
//# sourceMappingURL=langchain_indexes.js.map
